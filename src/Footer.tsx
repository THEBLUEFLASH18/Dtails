...
const content = {
  ...
  links: [
    ...
    { EN: 'Upholstery Purification',   ES: 'Purificación de Tapicería' },
  ],
      ...
      <div className="footer-body">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-socials">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/50497974295" target="_blank" rel="noopener noreferrer" className="footer-social" aria-label="WhatsApp">
        ...
        <div className="footer-col">
          ...
          <ul className="footer-contact-list">
            <li>
              ...
              <a href="https://wa.me/50497974295" target="_blank" rel="noopener noreferrer" style={{color: 'inherit', textDecoration: 'none'}}>+504 9797-4295</a>
            </li>
            <li>
              <span className="footer-contact-icon">
